...
const SearchFilters: React.FC<SearchFiltersProps> = ({
    ...
    return (
        <div className={`py-8 ${isDark ? 'bg-[#06171c] border-gray-700' : 'bg-white border-gray-200'} border-b`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => onFilterChange({ selectedSpecialty: e.target.value })}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => onFilterChange({ selectedExperience: e.target.value })}
                                    className={`w-full px-3 py-2 rounded-lg border transition-colors text-base ${isDark
                                            ? 'bg-gray-700 border-gray-600 text-white'
                                            : 'bg-white border-gray-300 text-gray-900'
                                        } focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20`}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => onFilterChange({ selectedRating: e.target.value })}
                                    className={`w-full px-3 py-2 rounded-lg border transition-colors text-base ${isDark
                                            ? 'bg-gray-700 border-gray-600 text-white'
                                            : 'bg-white border-gray-300 text-gray-900'
                                        } focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20`}
