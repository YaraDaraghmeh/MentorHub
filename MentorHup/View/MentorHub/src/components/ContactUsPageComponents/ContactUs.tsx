...
Sent via MentorHub Contact Form
  ...
  const handleMailtoFallback = () => {
    const mailtoLink = `mailto:yaradaraghmeh059@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`From: ${formData.email}\n\nMessage:\n${formData.message}`)}`;
  ...
  const themeClasses = {
    ...
    cardBg: isDark ? 'bg-gray-800/90 backdrop-blur-sm' : 'bg-white/90 backdrop-blur-sm',
    text: isDark ? 'text-white' : 'text-gray-900',
    textSecondary: isDark ? 'text-gray-300' : 'text-gray-600',
    border: isDark ? 'border-gray-700/50' : 'border-white/50',
    input: isDark ? 'bg-gray-700/80 border-gray-600/50 text-white placeholder-gray-400' : 'bg-white/80 border-gray-300/50 text-gray-900 placeholder-gray-500',
    button: isDark ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-600 hover:bg-blue-700',
    gradientCard: isDark ? 'from-blue-900/30 to-indigo-900/30' : 'from-blue-50/80 to-indigo-50/80',
    gradientCard2: isDark ? 'from-green-900/30 to-emerald-900/30' : 'from-green-50/80 to-emerald-50/80',
    gradientCard3: isDark ? 'from-purple-900/30 to-pink-900/30' : 'from-purple-50/80 to-pink-50/80'
  };

  return (
    <div className={`min-h-screen ${themeClasses.bg} py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden`}>
      {/* Background Pattern */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
            ...
            <h1 className={`text-3xl sm:text-4xl lg:text-5xl font-bold ${themeClasses.text} mb-4 drop-shadow-lg`}>
            Contact Mentor Hub
          </h1>
          <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-2xl mx-auto drop-shadow-sm`}>
            Connect with experienced interview trainers and boost your career success. 
            We're here to help you prepare for your next opportunity.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <h2 className={`text-2xl sm:text-3xl font-bold ${themeClasses.text} mb-6`}>
              Get in Touch
            </h2>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className={`font-semibold ${themeClasses.text} mb-1`}>Email Us</h3>
              ...
              >
                ...
                <div>
                  <h3 className={`font-semibold ${themeClasses.text} mb-1`}>Support</h3>
                  <p className={`${themeClasses.textSecondary} text-sm sm:text-base`}>
                    Get help with booking sessions, technical issues, or general inquiries
                  </p>
                </div>
              </motion.div>
            </div>

            <div className={`mt-8 p-6 rounded-xl bg-gradient-to-br ${themeClasses.gradientCard3} border ${themeClasses.border} backdrop-blur-sm`}>
              <h3 className={`font-semibold ${themeClasses.text} mb-3`}>About Mentor Hub</h3>
              <p className={`${themeClasses.textSecondary} text-sm leading-relaxed`}>
                Our platform specializes in connecting job seekers with experienced interview trainers 
                across various industries. Book personalized mock interview sessions and receive 
                professional coaching to improve your interview performance.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            {submitStatus === 'error' && (
              ...
              >
                ...
                <p className="text-red-300 text-sm">
                  There was an error sending your message. Please try the email option below.
                </p>
              </motion.div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <label htmlFor="email" className={`block text-sm font-medium ${themeClasses.text}  !text-gray-600 mb-2`}>
                  Your Email Address
                </label>
                <input
                  type="email"
              ...
              >
                <label htmlFor="subject" className={`block text-sm font-medium ${themeClasses.text}  !text-gray-600 mb-2`}>
                  Subject
                </label>
                <input
                  type="text"
              ...
              >
                <label htmlFor="message" className={`block text-sm font-medium ${themeClasses.text} !text-gray-600 mb-2`}>
                  Message
                </label>
                <textarea
                  id="message"
