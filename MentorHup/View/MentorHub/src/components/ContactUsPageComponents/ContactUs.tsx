          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              {submitStatus === "success" && (
                <div className={`mb-6 p-4 bg-green-500/20 border border-green-500/50 rounded-xl flex items-center space-x-3 backdrop-blur-sm animate-pulse`}>
              ...
              {submitStatus === "error" && (
                <div className={`mb-6 p-4 bg-red-500/20 border border-red-500/50 rounded-xl flex items-center space-x-3 backdrop-blur-sm animate-pulse`}>
