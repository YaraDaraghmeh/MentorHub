        ...
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/4 mb-4 lg:mb-0 lg:space-y-3">
            <div className="flex flex-row lg:flex-col space-x-2 lg:space-x-0 lg:space-y-3 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0">
              <div
                className={`flex items-center space-x-3 p-3 rounded-lg flex-shrink-0 ${
                  isDark
          ...
          <div className="absolute inset-0 bg-black bg-opacity-95 flex items-center justify-center z-50 rounded-2xl">
            <div className="relative w-full h-full flex items-center justify-center p-4">
              ...
              videoUrl.includes("youtu.be") ? (
                <iframe
                  src={videoUrl}
                  className={`w-full h-full max-w-4xl max-h-[80vh] rounded-lg shadow-2xl transition-opacity duration-300 ${
          ...
          <div className="text-center">
            ...
            >
              {isLoading ? (
                ...
                <FiPlay
                  className={`w-6 h-6 md:w-8 md:h-8 text-white ml-1 transition-transform duration-300 ${
                    isPlaying && showVideo ? "scale-125" : "scale-100"
                  }`}
                />
              )}
            </button>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          ...
          >
            ...
            MentorHub transforms your hiring process
          </p>
        </div>
